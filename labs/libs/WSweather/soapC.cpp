...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.11 2012-11-20 18:33:50 GMT")
...
void ns2__weatherParametersType::soap_default(struct soap *soap)
{
	...
	soap_default_bool(soap, &this->ns2__weatherParametersType::tstmprb);
	soap_default_bool(soap, &this->ns2__weatherParametersType::tstmcat);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns2__weatherParametersType(struct soap *soap, const char *tag, int id, const ns2__weatherParametersType *a, const char *type)
{
	...
	if (soap_out_bool(soap, "wwa", -1, &(a->ns2__weatherParametersType::wwa), ""))
		return soap->error;
	if (soap_out_bool(soap, "tstmprb", -1, &(a->ns2__weatherParametersType::tstmprb), ""))
		return soap->error;
	if (soap_out_bool(soap, "tstmcat", -1, &(a->ns2__weatherParametersType::tstmcat), ""))
		return soap->error;
...
SOAP_FMAC3 ns2__weatherParametersType * SOAP_FMAC4 soap_in_ns2__weatherParametersType(struct soap *soap, const char *tag, ns2__weatherParametersType *a, const char *type)
{
	...
	size_t soap_flag_tstmprb1 = 1;
	size_t soap_flag_tstmcat1 = 1;
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			...
			if (soap_flag_tstmprb1 && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_bool(soap, "tstmprb", &(a->ns2__weatherParametersType::tstmprb), "xsd:boolean"))
				{	soap_flag_tstmprb1--;
					continue;
				}
			if (soap_flag_tstmcat1 && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_bool(soap, "tstmcat", &(a->ns2__weatherParametersType::tstmcat), "xsd:boolean"))
				{	soap_flag_tstmcat1--;
					continue;
				}
